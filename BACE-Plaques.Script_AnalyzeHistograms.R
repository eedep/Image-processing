...
integral.data.BACE <- aggregate(integral.data.BACE[,13],by=list(`Animal ID`=integral.data.BACE$`Animal ID`,`Experimental Group`=integral.data.BACE$`Experimental Group`,`Genotype APP23`=integral.data.BACE$`APP23 Genotype`,`Genotype p40`=integral.data.BACE$`p40 Genotype`,`Age in Days`=integral.data.BACE$`Age in Days`,`Gender`=integral.data.BACE$`Gender`,`key`=integral.data.BACE$key),FUN=median
                              )
